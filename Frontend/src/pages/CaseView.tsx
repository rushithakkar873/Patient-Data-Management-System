...
const CaseViewComponent: React.FC = () => {
	...
	const handleCaseSubmit = () => {
		axios
			.put(`http://localhost:8080/gpt_response/update/${id}`, {
				doctorResponse,
			})
			.then(() => {
				toast({
	...
	return (
		<div className='p-4 flex flex-col gap-4'>
			...
			<div className='mt-4 flex flex-col gap-4'>
				...
				<div className='cols cols-span-2 mb-4 w-1/3'>
					<Label>Which response is better to share with this patient?</Label>
					<Select
						onValueChange={(value) =>
							setDoctorResponse({ ...doctorResponse, accepted: value })
						}
						required
					>
						<SelectTrigger>
							<SelectValue placeholder='Select one response or enter manual below' />
						</SelectTrigger>
						<SelectContent>
							<SelectGroup>
			...
			{/* <div className='mt-4'>
				...
				<p>
					...
					<Input
						...
						className='mt-2'
						onChange={(e) =>
							setDoctorResponse({ ...doctorResponse, response: e.target.value })
						}
					/>
				</p>
			</div> */}
