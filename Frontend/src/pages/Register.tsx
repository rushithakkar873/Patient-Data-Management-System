        ...
        <Card className="w-full max-w-xl mx-auto">
            ...
            <CardContent>
                <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        <Label>Gender</Label>
                        <Select defaultValue={formData.gender} onValueChange={(value) => setFormData(prev => ({ ...prev, gender: value }))} required>
                            <SelectTrigger>
                    ...
                    <div>
                        ...
                        <Input type="text" id="city" name="city" value={formData.city} onChange={handleChange} placeholder="Your city" required />
                    </div>
                    <div>
                        <Label htmlFor="state">State</Label>
                        <Input type="text" id="state" name="state" value={formData.state} onChange={handleChange} placeholder="Your state" required />
                    </div>
                    <div className="col-span-2">
                        <Label>I'm registering as a</Label>
                        <Select defaultValue={formData.role} onValueChange={(value) => setFormData(prev => ({ ...prev, role: value }))} required>
                            <SelectTrigger>
